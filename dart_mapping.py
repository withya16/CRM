...
GS_OUTPUT_WORKSHEET = os.getenv('GOOGLE_DART_OUTPUT_WORKSHEET', '경쟁사 협업 기업 리스트_with_dart')
...
def main():
    ...
    if "협력사/기관명" not in df.columns:
        raise ValueError("입력 데이터에 '협력사/기관명' 컬럼이 없습니다.")
